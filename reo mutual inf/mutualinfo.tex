...
\begin{table}
  \begin{center}
    ...
    \hline
     Neutral      & $<10^{-16}$ & $0.02$  \\
     Cryophilic   & $1\ee{-10}$ & $3\ee{-4}$  \\
     Thermophilic & $<10^{-16}$ & $7\ee{-7}$ \\
     Saltphilic   & $<10^{-16}$ & $4\ee{-5}$ \\
     Saltphobic   & $<10^{-16}$ & $5\ee{-12}$ \\
     \hline
    \end{tabular}
%    \begin{tabular}{|r|l|l|}
%      \hline
...
%    \end{tabular}
  \end{center}
  \caption[P-values for variability]{P-values for variability, \ie the likelihood of observing at least the spread seen in \fref{fig:variability} assuming no animal-to-animal variability. Computed with a $\chi^2$ test, \ie the binomial distribution was approximated by a Gaussian. Matlab cannot measure p-values $<10^{-16}$.}\label{tab:varipval}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{|r|l|l|l|l|}
    ...
    Saltphilic   & $1\ee{-7}$ & $<10^{-16}$ & $0.8$ & $0.04$ \\
  ...
  \end{center}
  %
  \caption[P-values for differences in conditional probabilities.]{P-values for differences in conditional probabilities for (a) reorientation type and (b) reorientation direction, computed with Z-tests. Matlab cannot measure p-values $<10^{-16}$.}\label{tab:condpval}
\end{table}
