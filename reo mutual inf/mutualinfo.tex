...
\begin{table}
  ...
  \begin{tabular}{|r|l|l|l|}
    ...
    Thermophilic & $0.004$ & $0.002$ & $7\ee{-7}$ \\
  ...
  \begin{tabular}{|r|l|l|l|}
    ...
    Saltphilic   & $0.9$ & $0.9$ & $0.7$ \\
    Saltphobic   & $0.99$ & $0.99$ & $0.98$ \\
    \hline
  \end{tabular}
  \begin{tabular}{|r|l|l|l|}
    \hline
    ...
    \hline
    Neutral      & $0.8$ & $0.7$ & $0.5$ \\
    Cryophilic   & $0.9$ & $0.9$ & $0.8$ \\
    Thermophilic & $0.7$ & $0.7$ & $0.5$ \\
    Saltphilic   & $0.9$ & $0.9$ & $0.8$ \\
    Saltphobic   & $0.7$ & $0.7$ & $0.5$ \\
    \hline
  \end{tabular}
  \end{center}
  %
  \caption[P-values for differences in conditional probabilities for reorientation direction restricted to certain reorientation types]{P-values for difference between marginal and conditional probabilities for reorientation direction restricted to certain reorientation types (data in \fref{fig:dirvstype}), computed with two-tailed Z-tests.}\label{tab:dirvstype}
\end{table}
