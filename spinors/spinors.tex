...
\end{equation*}
%
We can rewrite some of these relations, e.g., as \(\A^\dag = \alpha \At\).
...
We find that \(a = \pm 1\), \(b = 1\) and relations between the six signs above.
...
\begin{equation}\label{eq:raiselower}
  ...
  \brc{\Gammab_+^a, \Gammab_+^b} = \brc{\Gammab_-^a, \Gammab_-^b} = m\mathbf{0},
