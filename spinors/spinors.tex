...
\begin{table}
  ...
  \toprule
    \text{Matrix}  & \colhead{Similarity} & \colhead{Doubling} & \colhead{Constraint} 
        & \colhead{Normalisation} & \colhead{Ambiguity} \\
  \midrule
    \Gammab & -&\Gammab^\mu  &         \Gammab^2 &= \gamma \I  &               &-      &       \gamma &= 1   & \mathbb{Z}_2 \\
    \A      &  &\Gammab^\mud &    \A\inv \A^\dag &= \alpha \I  &  \abs{\alpha} &= 1    &       \alpha &= 1   & \R \\
    \At     & -&\Gammab^\mud &  \At\inv \At^\dag &= \alphat \I & \abs{\alphat} &= 1    &      \alphat &= s_1 & \R \\
            &&&               \At \Gammab \A\inv &= a \I       & \alpha a^*/a' &= \alphat &         a &= s_1 & \R       & (*) \\
            &&&          \At \A\inv \Gammab^\dag &= a' \I      &      \abs{a'} &= \abs{a} &        a' &= 1   & -        & (*) \\
    \B      &  &\Gammab^\muc &        \B \B^\ast &= \beta \I   &         \beta &\in \R &  \abs{\beta} &= 1   & U(1) \\
    \Bt     & -&\Gammab^\muc &      \Bt \Bt^\ast &= \betat \I  &        \betat &\in \R & \abs{\betat} &= 1   & U(1) \\
            &&&               \Bt \B\inv \Gammab &= b \I       &  \beta b^* b' &= \betat &          b &= 1   & U(1)     & (*) \\
            &&&          \Bt \Gammab^\ast \B\inv &= b' \I      &        b^* b' &\in \R   &         b' &= s_2 & -        & (*) \\
    \C      &  &\Gammab^\mut &   \C\inv \C\trans &= \chit \I   &        \chi^2 &= 1    &              &-     & \Cb^\ast \\
    \Ct     & -&\Gammab^\mut & \Ct\inv \Ct\trans &= \chit \I   &       \chit^2 &= 1    &              &-     & \Cb^\ast \\
            &&&               \Ct \Gammab \C\inv &= c \I       & \alpha a^*/a' &= \alphat &         c &= s_3 & \Cb^\ast & (*) \\
            &&&         \Ct \C\inv \Gammab\trans &= c' \I      &      \abs{a'} &= \abs{a} &        c' &= 1   & -        & (*) \\
  \bottomrule
  \end{tabular}
