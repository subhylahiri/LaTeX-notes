...
\end{equation}
%
One can show that (see \sref{sec:replicader}) the maximum has
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Appendices}\addtocontents{toc}{\bigskip \textbf{Appendices:}\par}%\addcontentsline{toc}{section}{Appendices:}
\appendix
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
