...
\end{equation}
%
It can be proved by expressing both sides in terms of the Fourier transforms $F$ and $G$ and verifying that the integrands are equal. It holds equally well when we replace functions by functionals and partial derivatives by functional derivatives.
%
\begin{proof}
  ...
  \begin{equation}\label{eq:wienergenex2}
    \begin{aligned}
      \av{\hz[J]\hz[\tj]} 
        =& \left. \e^{-\frac{\sigma^2}{2}\intd{v}\!\brk{\fdf{}{x(v)}+\fdf{}{y(v)}}^2} \!\!\int\!\!\frac{\dr t\dr s}{T^2} F_t[x(t')] F_s[y(s')] \e^{\frac{\ir}{\sigma^2}\intd{u}[x(t-u)J(u)+y(t-u)\tj(u)]} \right|_{x=y=0}.
    \end{aligned}
  \end{equation}
  %
  ...
  \begin{equation}\label{eq:wienergencov}
    \begin{aligned}
      \cov\prn{\hz[J],\hz[\tj]}  
        ...
        \\& \quad\quad\quad \left.
        \int\!\!\frac{\dr t\dr s}{T^2} F_t[x(t')] F_s[y(s')] \e^{\frac{\ir}{\sigma^2}\intd{u}[x(t-u)J(u)+y(t-u)\tj(u)]} \right|_{x=y=0}.
    \end{aligned}
  \end{equation}
  %
  Note that
  ...
  \begin{equation*}
    \e^{-\sigma^2\intd{v}\fdf{}{x(v)}\fdf{}{y(v)}}-1 = 
      \sum_{n=}^\infty \frac{(-\sigma^2)^n}{n!} \brk{ \intd{v}\fdf{}{x(v)}\fdf{}{y(v)} }^n,
  \end{equation*}
  %
